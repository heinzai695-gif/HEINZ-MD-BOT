...
cmd({
    ...
    if (mode === "on") {
        ...
        return reply(`- *𝐇𝐄𝐈𝐍𝐙 𝐌𝐃 𝐂𝐇𝐀𝐓𝐁𝐎𝐓 𝐌𝐄𝐍𝐔*
*ᴇɴᴀʙʟᴇ sᴇᴛᴛɪɴɢs ✅*      
...
cmd({
    ...
    try {
        ...
        if (data && data.status && data.BK9) {
            ...
            reply("⚠️ Heinz md failed to generate a response.");
        }
